...
final class ListQuotesController extends Controller
{
    ...
    #[Response(type: 'Illuminate\Http\Resources\Json\AnonymousResourceCollection<Proovit\Billing\Http\Resources\Api\Quotes\QuoteResource>', description: 'Paginated quotes with company, customer, conversion, lines, and monetary totals.')]
